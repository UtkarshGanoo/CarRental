  ...
  return (
    <div className="px-4 py-10 md:px-10 flex-1 bg-[#F0E491]">
      ...
      <form
        ...
        className="flex flex-col gap-5 text-black text-sm mt-6 max-w-xl"
      >
        {/* Car Image */}
        <div className="flex items-center gap-2 w-full">
          ...
          <p className="text-sm text-black">Upload a picture of your car</p>
        </div>
        {/* Car brand and model */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col w-full">
            ...
            <input
              type="text"
              placeholder="e.g. hundai,tata,suzuki"
              required
              className="px-3 py-2 mt-1 border border-black rounded-md outline-none"
              value={car.brand}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <div className="flex flex-col w-full">
            ...
            <input
              ...
              placeholder="2025"
              required
              className="px-3 py-2 mt-1 border border-black
...
rounded-md outline-none"
        ...
        <div className="flex flex-col w-full">
          ...
          <textarea
            rows={5}
            placeholder="e.g. A cars with a spacious interior and a powerful engine."
            required
            className="px-3 py-2 mt-1 border border-black
rounded-md outline-none"
